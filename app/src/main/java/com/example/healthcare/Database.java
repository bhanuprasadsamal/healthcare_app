...
public class Database extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        String qry1 = "create table users(username text,email text,city text,password text)";
    ...
    public void register(String username,String email,String city, String password){
    ...
    public ArrayList getOrderData(String username){
        ...
        if(c.moveToFirst()){
            do{
                arr.add(c.getString(1)+"$"+c.getString(2)+"$"+c.getString(3)+"$"+c.getString(4)+"$"+c.getString(6)+"$"+c.getString(7));
            }while(c.moveToNext());
        }
        db.close();
        return arr;
